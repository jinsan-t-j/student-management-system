    ...
    <div class="col-md-10">
        <div class="block">
            <div class="block-header block-header-default">
                <h3 class="block-title"> Edit Mark </h3>
                <div class="block-options justify-content-center align-items-center">
                    @if (count($students) < 1)
                        <div class="category-empty">
                            <p class="text-danger m-0"> To edit mark please create some students.&nbsp;&nbsp;&nbsp;
                            ...
                            <div class="form-material">
                                <select class="select2 browser-default" id="material-student_id" name="student_id" {{ count($students) < 1 ? 'disabled' : false }} data-placeholder="Please select a student">
                                    ...
                                    @foreach ($students as $student)
                                        <option value="{{ $student->id }}" {{ old('student_id', $mark->student_id) === $student->id ? 'selected' : false }}> {{ $student->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-9">
                            <div class="form-material input-group">
                                <input type="text" class="form-control" id="material-addon-icon" name="maths"
                                    placeholder="Please enter the maths" value="{{ old('maths', $mark->maths) }}">
                        ...
                        <div class="col-md-9">
                            <div class="form-material input-group">
                                <input type="text" class="form-control" id="material-addon-icon" name="science"
                                    placeholder="Please enter the science" value="{{ old('science', $mark->science) }}">
                        ...
                        <div class="col-md-9">
                            <div class="form-material input-group">
                                <input type="text" class="form-control" id="material-addon-icon" name="history"
                                    placeholder="Please enter the history" value="{{ old('history', $mark->history) }}">
                        ...
                        <div class="col-md-9">
                            <div class="form-material">
                                <select class="select2 browser-default" id="material-term" name="term" data-placeholder="Please select a term">
                                    <option value=""></option>
                                    <option value="One" {{ old('term', $mark->term) === "One" ? 'selected' : false }}> One </option>
                                    <option value="Two" {{ old('term', $mark->term) === "Two" ? 'selected' : false }}> Two </option>
                                </select>
