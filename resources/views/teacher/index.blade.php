...
@section('content')
    ...
    <div class="content">
        <div class="my-50 text-center">
            <h2 class="font-w700 text-black mb-10"> Teachers </h2>
                ...
                <div class="block">
                    <div class="block-content">
                        <p class="text-muted text-center">
                            Here you can manage all the Teachers
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="block">
            <div class="block-header block-header-default">
                ...
                <a href="{{ route('teachers.create') }}" data-toggle="click-ripple"
            ...
            <div class="block-content block-content-full">
                ...
                <div class="table-responsive">
                    <table id="teachers" class="table table-bordered table-striped table-vcenter js-dataTable-full" data-url="{{ route('teachers.index') }}">
                        <thead>
                            <tr>
